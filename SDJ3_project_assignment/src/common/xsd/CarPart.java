...
public class CarPart implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Car
     */
    protected common.xsd.Car localCar;
     ...
     * @return common.xsd.Car
     */
    public common.xsd.Car getCar() {
        return localCar;
    }
     ...
     * @param param Car
     */
    public void setCar(common.xsd.Car param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CarPart", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CarPart", xmlWriter);
        ...
        if (localCarTracker) {
            if (localCar == null) {
                writeStartElement(null, "http://common/xsd", "car", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static CarPart parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            CarPart object = new CarPart();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CarPart".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CarPart) tier2.webserver.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://common/xsd", "car").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setCar(common.xsd.Car.Factory.parse(reader));
