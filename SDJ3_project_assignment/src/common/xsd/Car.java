...
public class Car implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected boolean localChassisNumberTracker = false;
    ...
    public boolean isChassisNumberSpecified() {
        return localChassisNumberTracker;
    }
    ...
    public java.lang.String getChassisNumber() {
        return localChassisNumber;
    }

    /**
     * Auto generated setter method
     * @param param ChassisNumber
     */
    public void setChassisNumber(java.lang.String param) {
        localChassisNumberTracker = true;

        this.localChassisNumber = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localChassisNumberTracker) {
            namespace = "http://common/xsd";
            writeStartElement(null, namespace, "chassisNumber", xmlWriter);

            if (localChassisNumber == null) {
                // write the nil attribute
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "nil", "1",
                    xmlWriter);
            } else {
                xmlWriter.writeCharacters(localChassisNumber);
            }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Car".equals(type)) {
                            ...
                            return (Car) tier2.webserver.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://common/xsd",
                            "chassisNumber").equals(reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setChassisNumber(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
