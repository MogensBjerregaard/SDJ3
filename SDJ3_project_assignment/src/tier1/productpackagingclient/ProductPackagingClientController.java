...
public class ProductPackagingClientController extends UnicastRemoteObject implements ISubscriber {
	...
	private static final String registryName = "ProductPackagingClient";
	private IBusinessServer businessServer;
	
	public ProductPackagingClientController(IBusinessServer businessServer)
	...
	public void generateNewProduct(HashMap<String, Integer> carPartTypeAndQuantity)
			throws RemoteException {
