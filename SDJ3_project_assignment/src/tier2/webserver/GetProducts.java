...
/**
 *  GetProducts bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetProducts implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getProducts", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getProducts", xmlWriter);
            }
        }

        if (localArgs0Tracker) {
            namespace = "http://webserver.tier2";
    ...
    public static class Factory {
         ...
         */
        public static GetProducts parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            GetProducts object = new GetProducts();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getProducts".equals(type)) {
                            ...
                            return (GetProducts) tier2.webserver.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://webserver.tier2", "args0").equals(
                            reader.getName())) {
